...
import { King, Pawn } from './pragmatic-drag-and-drop/documentation/examples/pieces/getting-started/draggable-piece-with-data';
import Square from './pragmatic-drag-and-drop/documentation/examples/pieces/getting-started/square-with-data';
